...
_KEYWORD_RULES: list[tuple[str, list[str]]] = [
    ("Одежда", [
        "майк", "футболк", "поло", "джинс", "брюк", "штан", "шорт",
    ...
    ("Рестораны и еда", [
        ...
        "евроопт", "еврооопт", "перекрёсток", "перекресток",
        ...
        "продуктов", "продуктов на", "продуктовый",
        "энергетик", "напиток",
    ...
    ("Здоровье", [
        ...
        "фитнес", "спортзал", "тренажер", "абонемент",
        "бассейн", "йога", "пилатес",
        "массаж", "спа", "spa", "санатори",
        "тонометр", "градусник", "пластырь", "бинт",
